...
| 강 | 제목 | 핵심 내용 |
|----|------|----------|
| 1강 | AI 마인드셋 + Claude Pro 시작 | 바이브 코딩이란, Claude 유출 System Prompt 분석 |
| 2강 | GitHub + Claude Code 환경 세팅 | Git 기초, Claude Code 설치, CLAUDE.md 작성 |

### PART 2 — Claude Code 심화 + 에이전트 (3~4강)

| 강 | 제목 | 핵심 내용 |
|----|------|----------|
| 3강 | Claude Code Skills & 커스텀 자동화 | Skills 만들기, 프롬프트 패턴, [cokacdir](https://github.com/waterfirst/cokacdir) 소개 |
| 4강 | Claude Agent 모드 + Cowork | 멀티 에이전트, [CLI-Anything](https://github.com/waterfirst/CLI-Anything) 탐색 |

> **🎯 [프로젝트 1](projects/project1/README.md)** — 나의 디스플레이 관심 분야 소개 웹페이지 (GitHub Pages 배포)
...
| 강 | 제목 | 핵심 내용 |
|----|------|----------|
| 11강 | 배포 플랫폼 10종 총정리 | GitHub Pages·Streamlit·Vercel·Firebase 등 비교 |
| 12강 | 환경 관리 & 보안 & CI/CD | .env, .gitignore, GitHub Actions 자동 배포 |
